...
public class SkeletBossMov2: MonoBehaviour
{
    ...
    void Update()
    {
        ...
        playerDistance = Vector2.Distance(mob.transform.position, player2.transform.position); //расстояние до игрока
        var movVect = player2.transform.position - mob.transform.position; //направление на игрока
        ...
        var moVect = player2.transform.position - mob.transform.position;
    ...
    void walk()
    {
        ...
        var movVect = player2.transform.position - mob.transform.position;
