...
public class OrcMovement2 : MonoBehaviour
{
    ...
    private HP2 player_HP; // переменная для определения игрока
    public float dmg;

    // Use this for initialization
    void Start()
    {
        player_HP = GameObject.FindGameObjectWithTag("Player2").GetComponent<HP2>(); // оперделение игрока
