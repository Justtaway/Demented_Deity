...
public class Inventory : MonoBehaviour
{
	...
	public static event ItemDelegate ItemConsumed2;
    public static event ItemDelegate ItemEquip;
	public static event ItemDelegate ItemEquip2;
    public static event ItemDelegate UnEquipItem;
	public static event ItemDelegate UnEquipItem2;
	...
	public void ConsumeItem2(Item item)
	{
	...
	public void EquiptItem2(Item item)
	{
		if (ItemEquip2 != null)
			ItemEquip2(item);
	}
	...
	public void UnEquipItem3(Item item)
	{
		if (UnEquipItem2 != null)
			UnEquipItem2 (item);
	}
...
//                        temp.GetComponent<ConsumeItem>().duplication.GetComponent<ItemOnObject>().item.itemValue = stack;
					if (temp != null && temp.GetComponent<ConsumeItem2>().duplication != null)
						temp.GetComponent<ConsumeItem2>().duplication.GetComponent<ItemOnObject>().item.itemValue = stack;
                    return true;
                }
            }
        }
