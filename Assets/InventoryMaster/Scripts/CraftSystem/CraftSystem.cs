...
public class CraftSystem : MonoBehaviour
{
    ...
    public void backToInventory()
    {
        ...
        {
            GameObject.FindGameObjectWithTag("Player").GetComponent<Player>().inventory.GetComponent<Inventory>().addItemToInventory(itemInCraftSystem[i].itemID, itemInCraftSystem[i].itemValue);
